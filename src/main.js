...
function getData(data) {
  ...
  data.forEach((value) => {
    ...
    <div class="flex items-center justify-between">
        <button
            class="bg-[#6666ff] mt-[15px] text-white text-[13px] border-2 border-blue-500 bg-vivid-blue p-[10px_20px] rounded-xl relative overflow-hidden transition-all duration-500 before:absolute before:top-0 before:right-full before:w-full before:h-full before:bg-[blue] before:transition-all before:duration-200 hover:before:right-0"
        >
